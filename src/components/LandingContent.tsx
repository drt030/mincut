      ...
      <section className="landing-hero" aria-labelledby="landing-title">
        <div className="landing-hero-copy">
          ...
          <p className="landing-lede">
            ...
            fusion are paid-candidate previews: component routes and evidence are visible, while organization exposure
            stays locked until checkout and entitlement gates are verified.
          </p>
          <p className="landing-zh">
            AI compute 和 parcel robot 是用于判断方法的参考图谱。Humanoid robotics 与 controlled fusion 现在是
            paid-candidate preview：部件路线和证据可见，组织与股票 exposure 仍在付费层锁定，直到 checkout 与 entitlement gate
            验证完成。本工具用于产业研究，不构成投资建议。
          </p>
      ...
      <section className="landing-section" aria-labelledby="domains-title">
        <div className="landing-section-head">
          ...
          <p className="muted">
            ...
            as paid-candidate previews while their exposure layer, checkout, and update model remain under review.
          </p>
        </div>
